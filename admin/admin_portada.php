                                        ...
                                        <table id="table_id" class="display ">
											...
											<?php
												...
												?>
                                                        ...
                                                        <?php include('modaleliminaradmin.php')?>
                                                        
                                                        <?php include('modaleditaradmin.php')?>
...
<br> <br>
			<a href="../cerrar_sesion.php"><button class="btn btn-danger text-left float-right"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> Cerrar Sesion</button></a>
	</div>
